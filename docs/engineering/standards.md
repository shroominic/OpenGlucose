...
| Sensitive-log controls           | Restricted data         | BLE plugin release logs disabled; broader verification pending | Startup-order and log-policy tests; production/device recheck still required | `@shroominic` | Before external release           |
