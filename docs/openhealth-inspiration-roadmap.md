# OpenHealth Task Board and Roadmap From `other-apps-to-take-inspiration`

## Purpose

This document compiles the reverse-engineering notes in `other-apps-to-take-inspiration/` into a concrete product backlog for OpenHealth.
...
This roadmap pulls from all major analyses in `other-apps-to-take-inspiration/docs/`.

| App | Best ideas worth extracting | OpenHealth fit |
| --- | --- | --- |
| [`Lingo`](../other-apps-to-take-inspiration/docs/apk-analysis/com.abbott.lingo.wellness.md) | Lingo Count, weekly snapshots, dynamic targets, challenges, mood/energy check-ins | High for snapshots/targets, medium for gamification |
| [`GlucoSense`](../other-apps-to-take-inspiration/docs/apk-analysis/com.app.glucosense.md) | multi-provider ingestion, AI summaries, diabetes metrics, caregiver/follower flows | High for ingestion/insights, medium for caregiver/admin |
| [`Stelo`](../other-apps-to-take-inspiration/docs/apk-analysis/com.dexcom.stelo.md) | pairing recovery, target ranges, event logging, safety education, provider sharing | Very high for onboarding, alerts, reliability |
| [`Veri`](../other-apps-to-take-inspiration/docs/apk-analysis/com.humanengineering.md) | meal-response scoring, food quality guidance, repeated sensor programs | High for explainable meal scoring |
| [`Levels`](../other-apps-to-take-inspiration/docs/apk-analysis/com.levelshealth.md) | explainable glucose scoring, habit loops, health-data sync, voice logging | High for analytics and low-friction logging |
| [`Nutrisense`](../other-apps-to-take-inspiration/docs/apk-analysis/com.nutrisense.md) | coaching/chat, labs, reports, macros, weight programs | Medium for reports/macros, low for telehealth |
| [`SIBIONICS GS3`](../other-apps-to-take-inspiration/docs/apk-analysis/com.sisensing.gs3.md) | structured logbook, medication taxonomy, reminders, widgets, remote monitoring | High for logbook/reminders/widgets |
| [`SIBIONICS GS1`](../other-apps-to-take-inspiration/docs/apk-analysis/com.sisensing.sijoy.md) | lighter version of logbook/reminders/follower model | High for minimum viable versions |
| [`Supersapiens`](../other-apps-to-take-inspiration/docs/apk-analysis/com.supersapiens.md) and [`extra analysis`](../other-apps-to-take-inspiration/docs/SUPERSAPIENS_ANALYSIS.md) | athlete event model, fueling zones, Garmin/Wahoo, performance analytics | High for optional athlete mode |
| [`Ultrahuman`](../other-apps-to-take-inspiration/docs/apk-analysis/com.ultrahuman.android.md) | AI meal capture, widgets, mode-based programs, multi-signal expansion | Medium for meal capture and mode framing |
| [`Vively`](../other-apps-to-take-inspiration/docs/apk-analysis/com.vively.vively.md) | local journaling tables, AI advisor, challenges, community, biomarker framing | High for local journaling, medium for AI/challenges |
