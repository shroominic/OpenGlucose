...
/// Minimal, self-contained "AI insights (optional)" settings pane.
///
    ...
    return ListView(
      ...
      children: <Widget>[
        ...
        SwitchListTile(
          ...
          subtitle: const Text('Off by default. Requires your own API key.'),
        ...
        Wrap(
          ...
          children: <Widget>[
            ...
            OutlinedButton.icon(
              onPressed: (_busy || !_settings.enabled) ? null : _generateNow,
              icon: const Icon(Icons.science_outlined),
              label: const Text('Generate insights now'),
            ),
          ],
        ),
